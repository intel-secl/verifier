...
replace intel/isecl/lib/flavor/v3 => github.com/intel-secl/flavor/v3 v3.6.0

replace github.com/intel-secl/intel-secl/v3 => github.com/intel-secl/intel-secl/v3 v3.6.0
